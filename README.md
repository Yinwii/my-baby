...
### v1.1.2 (最新)
- 🎨 仪表盘成长图表全面美化：
  - 删除了"查看详细记录"和"添加成长记录"按钮，简化界面
  - 升级容器样式：多层渐变背景（翠绿→青绿→蓝绿）和增强阴影效果
  - 美化图表元素：彩色坐标轴、半透明翠绿色网格线、增大数据点和线条
  - 改进工具提示：翠绿色边框、彩色阴影、图标标识
  - 新增统计信息卡片：显示记录天数和最新记录日期
  - 优化空状态显示：更大图标、装饰性分割线、分层布局
- ✨ 提升用户体验：专注内容展示，简化操作流程
